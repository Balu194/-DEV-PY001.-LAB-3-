def count_letters(text):
    ...
    for char in text.lower():
        if char.isalpha():  # проверка символа
...
def calculate_frequency(letter_count):
    ...
    for letter, count in letter_count.items():
        frequency[letter] = round(count / total_letters, 2)  # Вычисляем частоту и округляем до двух знаков
...
# Подсчет букв и вычисление частоты
